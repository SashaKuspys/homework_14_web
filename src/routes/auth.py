...
async def signup(body: UserSchema, bt: BackgroundTasks, request: Request, db: AsyncSession = Depends(get_db)):
    ...
    The signup function creates a new user in the database.
        ...
        If the email already exists, it raises an HTTPException with status code 409 and message ACCOUNT_EXIST.
        Otherwise, it hashes the password using auth_service's get_password_hash function and then creates a new user with that hashed password.
